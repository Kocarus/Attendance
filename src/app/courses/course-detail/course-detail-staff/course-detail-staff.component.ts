...
// this.excelService.writeAttendanceList(
        ...
        for (var i = 0; i < this.attendance_list.length; i++){
            ...
            for(var i = 1 ;i<= 22;i++)
                item.push('')
            dd.content[2]['table'].body[i + 1] = item
